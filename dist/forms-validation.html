                    ...
                    <div class="card-body">
                        ...
                        <form action="" id="myform" method="get" onsubmit = "return validate();">
                            <div class="mb-2 input_field">
                                <label for="name" class="mb-2 label">Username</label>
                                <input class="form-control" type="text" id="name" placeholder="Username">
                            </div>
                            <div class="mb-2 input_field">
                                <label for="subject" class="mb-2 label">Subject</label>
                                <input class="form-control" type="text" id="subject" placeholder="Subject">
                            </div>
                            <div class="mb-2 input_field">
                                <label for="phone" class="mb-2 label">Phone No</label>
                          ...
                          <div class="input_field mb-2">
                            <label for="massage" class="mb-2 label">Massage</label>
                            <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-200 focus:ring-blue-500 focus:border-blue-500 dark:bg-slate-700 dark:border-slate-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Leave a comment..."></textarea>
                          </div>
                          <button type="submit" class="px-3 py-2 lg:px-4 bg-blue-500 text-white text-sm font-semibold rounded hover:bg-blue-600">Submit form</button>
                        </form>
                    </div><!--end card-body-->
